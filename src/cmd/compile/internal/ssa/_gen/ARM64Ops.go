...
func init() {
	...
	ops := []opData{
		...
		// combination of Cond, Nzcv and possibly Imm(constant value)
		{name: "CCMP", argLength: 3, reg: gp2flagsflags, asm: "CCMP", aux: "ARM64ConditionalParams", typ: "Flag"},      // (Cond == arg2) ? CMP arg0 arg1 : set Nzcv from auxint
		{name: "CCMN", argLength: 3, reg: gp2flagsflags, asm: "CCMN", aux: "ARM64ConditionalParams", typ: "Flag"},      // (Cond == arg2) ? CMN arg0 arg1 : set Nzcv from auxint
		{name: "CCMPconst", argLength: 2, reg: gp1flagsflags, asm: "CCMP", aux: "ARM64ConditionalParams", typ: "Flag"}, // (Cond == arg2) ? CMPconst [Imm] arg0 : set Nzcv from auxint
		{name: "CCMNconst", argLength: 2, reg: gp1flagsflags, asm: "CCMN", aux: "ARM64ConditionalParams", typ: "Flag"}, // (Cond == arg2) ? CMNconst [Imm] arg0 : set Nzcv from auxint

		{name: "CCMPW", argLength: 3, reg: gp2flagsflags, asm: "CCMPW", aux: "ARM64ConditionalParams", typ: "Flag"},      // (Cond == arg2) ? CMPW arg0 arg1 : set Nzcv from auxint
		{name: "CCMNW", argLength: 3, reg: gp2flagsflags, asm: "CCMNW", aux: "ARM64ConditionalParams", typ: "Flag"},      // (Cond == arg2) ? CMNW arg0 arg1 : set Nzcv from auxint
		{name: "CCMPWconst", argLength: 2, reg: gp1flagsflags, asm: "CCMPW", aux: "ARM64ConditionalParams", typ: "Flag"}, // (Cond == arg2) ? CMPWconst [Imm] arg0 : set Nzcv from auxint
		{name: "CCMNWconst", argLength: 2, reg: gp1flagsflags, asm: "CCMNW", aux: "ARM64ConditionalParams", typ: "Flag"}, // (Cond == arg2) ? CMNWconst [Imm] arg0 : set Nzcv from auxint
